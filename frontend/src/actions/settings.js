...
import { CHANGE_PASSWORD_REQUEST, CHANGE_PASSWORD_SUCCESS, CHANGE_PASSWORD_FAILTUE} from './types';
...
export const changePassword = ({ old_password, new_password, new_password2 }) => {
    return (dispatch, getState) => {
        ...
        axios.patch(`api/auth/change_password/`, data, authHeader(getState))
        .then((res) => {
            dispatch({
