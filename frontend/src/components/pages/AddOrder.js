...
const AddOrder = () => {
    ...
    return (
        ...
        <div className="border-b border-gray-200 sm:rounded-lg bg-gray-50 p-4">
          <h1 className="m-2 font-bold text-gray-600 border-b border-gray-200 p-2">Nowe zlecenie</h1>
            ...
            <button onClick={onSubmit} type="button" className="bg-gray-300 hover:bg-gray-400 text-gray-700 text-base px-6 py-2 m-2 rounded-lg">Dodaj zlecenie</button>
